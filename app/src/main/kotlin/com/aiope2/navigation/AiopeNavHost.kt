...
@Composable
fun AiopeNavHost(navHostController: NavHostController, composeNavigator: AppComposeNavigator, providerStore: ProviderStore, toolStore: ToolStore) {
  NavHost(
    navController = navHostController,
    startDestination = AiopeScreens.Chat.route,
  ) {
    aiopeNavigation(composeNavigator = composeNavigator, providerStore = providerStore, toolStore = toolStore)
  }
}
