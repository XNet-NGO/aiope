  ...
  suspend fun execute(name: String, args: Map<String, Any?>): String {
    ...
    return when (name) {
      ...
      "schedule_task" -> {
        ...
        val allowedTools = setOf("search_web", "fetch_url", "run_sh", "ssh_exec", "send_notification", "set_alarm", "memory_store", "memory_recall")
